...
def shell(title, body, active="", desc="Ananda Labs — a one-person research lab building the harness for minds: agents, doctrine, tools, and the tesseract."):
...
<meta property="og:title" content="{html.escape(title)}"><meta property="og:description" content="{html.escape(desc)}"><meta property="og:image" content="https://ananda.akeyo.io/assets/og.png">
...
<section class="hero">
  ...
  <div class="copy">
    ...
    <p class="one">A one-person research lab building the <em>harness</em> for minds — agents, control planes, doctrine, and the tools that make a frontier model operate.</p>
...
"""
open(os.path.join(ROOT,"index.html"),"w").write(shell("Ananda Labs", index_body))
...
open(os.path.join(ROOT,"projects.html"),"w").write(shell("Projects — Ananda Labs", f'<section><h1>Projects</h1><p class="lede">Everything public, straight from the living registry. Each has code; most have a demo.</p>{sections}</section>', "projects"))
...
<h2>Principles we operate by</h2><ul class="creed"><li><b>Ground truth beats memory.</b> Re-derive before acting.</li><li><b>Verification is the work,</b> not the epilogue.</li><li><b>Cheap gates before expensive work.</b></li><li><b>The user's words are sacred data.</b> Verbatim first, derivation second.</li><li><b>Claims fight or they retire.</b> Identical tasks, fresh sessions, measured.</li><li><b>Polish over accretion.</b></li></ul></section>""", "doctrine"))
